...
if  [ $CURL ]; then
    curl -sL https://github.com/borgbackup/borg/releases/download/1.1.14/borg-linux64 -o /usr/local/bin/borg
else
    wget -q https://github.com/borgbackup/borg/releases/download/1.1.14/borg-linux64 -O /usr/local/bin/borg
fi
...
if  [ $CURL ]; then
    curl -sL https://git.lunix.com.ar/pramos/borg_config/raw/branch/master/borg_config -o /usr/local/sbin/borg_config
    curl -sL https://git.lunix.com.ar/pramos/borg_config/raw/branch/master/borgcron.conf.template -o /etc/lunix/borg/client/borgcron.conf.template
else
    wget -q https://git.lunix.com.ar/pramos/borg_config/raw/branch/master/borg_config -O /usr/local/sbin/borg_config
    wget -q https://git.lunix.com.ar/pramos/borg_config/raw/branch/master/borgcron.conf.template -O /etc/lunix/borg/client/borgcron.conf.template
fi
...
if  [ $CURL ]; then
    curl -sL https://git.lunix.com.ar/pramos/borg_config/raw/branch/master/borg_tools_storage -o /usr/local/sbin/borg_tools_storage
    curl -sL https://git.lunix.com.ar/pramos/borg_config/raw/branch/master/borgcron-prune-server -o /etc/lunix/borg/borgcron-prune
else
    wget -q https://git.lunix.com.ar/pramos/borg_config/raw/branch/master/borg_tools_storage -O /usr/local/sbin/borg_tools_storage
    wget -q https://git.lunix.com.ar/pramos/borg_config/raw/branch/master/borgcron-prune-server -O /etc/lunix/borg/borgcron-prune
fi
